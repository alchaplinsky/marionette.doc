...
Please see
[the Marionette.CollectionView documentation](collection_view.html)
...
For more information on this method, see the [CollectionView's documentation](collection_view.html).
...
For more information, see the [Marionette.View](view.html) documentation.
