...
* [View "dom:refresh" / onDomRefresh event](#view-dom-refresh-ondomrefresh-event)
* [View.triggers](#view-triggers)
* [View.events](#view-events)
* [View.modelEvents and View.collectionEvents](#view-modelevents-and-view-collectionevents)
* [View.serializeData](#view-serializedata)
* [View.bindUIElements](#view-binduielements)
* [View.templateHelpers](#view-templatehelpers)
...
This event can be used to react to when a view has been shown via a [region](/marionette/regions/region.html).
