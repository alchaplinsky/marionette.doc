...
[the Marionette.View documentation](view.html)
...
* [Events and Callback Methods](#events-and-callback-methods)
  * ["before:render" / onBeforeRender event](#-before-render-onbeforerender-event)
  * ["render" / onRender event](#-render-onrender-event)
  * ["before:close" / onBeforeClose event](#-before-close-onbeforeclose-event)
...
As documented in [Marionette.View](/marionette/view/view.html), you can specify a `ui` hash in your `view` that
...
For more information, see the [Marionette.View](/marionette/view/view.html) documentation.
